...
const Card = ({card, onCardClick, onCardLike, onCardDelete, onViewCard}) => {
    ...
    const cardLikeButtonClassName = `image-button elements__like ${isLiked ? 'active' : ''}`;
    return (
        <div className="elements__item" onClick={() => onCardClick(card)}>
            ...
            <div className="elements__title">
                ...
                <div className="elements__likes-container">
                    <button className={cardLikeButtonClassName} type="button" disabled={loading}
                            onClick={(e) => {
                        e.stopPropagation();
                        onCardLike(card);
                    }}/>
            ...
            {isOwn && <button className="image-button elements__delete" type="button" onClick={(e) => {
                e.stopPropagation();
                onCardDelete(card);
            }}/>}
        </div>
