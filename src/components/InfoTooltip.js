...
const InfoTooltip = memo(({success, onClose, isOpen}) => (
    <div className={`popup ${isOpen ? "popup_opened" : ""}`} id="placeViewerPopup">
        <div className="popup__container">
            <figure className="tooltip">
                <img className="popup__image tooltip__image" src={success ? Success : Error} alt=''/>
                <figcaption className="tooltip__caption">{success ? SUCCESS_MESSAGE : ERROR_MESSAGE}</figcaption>
            </figure>
